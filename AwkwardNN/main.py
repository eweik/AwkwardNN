...
import torch
import numpy as np
from preprocessAwkwardData import get_dataloader
import time
import trainAwkardNet
from config import get_config
from utils import print_time
from preprocessAwkwardData import *
...
def main(config):
    ...
    trainer = trainAwkardNet.AwkwardNNTrainer(config, config.max_depth, 1, 2, dataloader)
    if config.train:
        trainer.train()
    else:
        trainer.test()
