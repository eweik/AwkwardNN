...
class awkwardNN(object):
    def __init__(self, *, rnn_fields=[], gru_fields=[],
                 lstm_fields=[], deepset_fields=[],
        ...
        self.rnn_fields = rnn_fields
        self.gru_fields = gru_fields
        self.lstm_fields = lstm_fields
        self.deepset_fields = deepset_fields
    ...
    def train(self, rootfile):
        self._init_training(rootfile)
    ...
    def _init_training(self, roottree):
        self._init_dataloaders(roottree)
        self._init_model()
    ...
    def _init_dataloaders(self, roottree):
        kwargs = {'rnn_fields': self.rnn_fields, 'lstm_fields': self.lstm_fields,
                  'gru_fields': self.gru_fields, 'deepset_fields': self.deepset_fields}
        self.dataset = AwkwardDataset(roottree, **kwargs)
